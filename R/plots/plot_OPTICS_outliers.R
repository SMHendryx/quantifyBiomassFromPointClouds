# Script plots OPTICS clusters and outliers
...
inpath = "/Users/seanmhendryx/Data/thesis/Processed_Data/T-lidar" 
setwd(inpath)
...
p = ggplot() + geom_point(mapping = aes(x = X, y = Y, color = factor(Label)), data = clusters, size = .75) + theme_bw() + theme(legend.position="none") + coord_equal() + scale_colour_manual(values = cbf)
